...
class UserAnswerController extends Controller
{
    ...
    public function show($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->body(Admin::show(UserAnswer::findOrFail($id), function (Show $show) {
    ...
    {
        return Admin::grid(UserAnswer::class, function (Grid $grid) {
...
//            });
    ...
    {
        return Admin::form(UserAnswer::class, function (Form $form) {
